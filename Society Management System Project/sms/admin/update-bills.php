...
$query->bindParam(':block',$block,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Electricity Bill detail has been added.")</script>';
...
<head>
<title>Society Maintenance System || Flat Bill</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item active">Flat Bill</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<tr>
 ...
 <hr color="blue"/>                       
   <?php } else {?>
    <h3 align="center" style="color:red"> Flat not alloted</h3>
<?php } ?>
